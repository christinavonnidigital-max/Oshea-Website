...
const ServiceDetailPage: FC = () => {
  ...
  // Generate dynamic keywords for the specific service.
  const dynamicKeywords = `${service.title}, O'Shea SA, TÜV NORD, ${service.title} services, ISO standards, Sub Sahara Africa`;
