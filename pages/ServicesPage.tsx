        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
             ...
             <div className="bg-gray-50 rounded-xl p-8 border border-gray-200 hover:shadow-lg transition-all">
                <h3 className="text-2xl font-bold text-[#0F1A3E] mb-3">ISO 9001 Certification</h3>
                <p className="text-gray-600 mb-6">The global standard for Quality Management Systems. Essential for tenders and operational excellence.</p>
                <Link to="/iso-9001" className="text-orange-600 font-semibold hover:text-orange-700 flex items-center group">
                   Learn more <span className="ml-2 transform group-hover:translate-x-1 transition-transform">→</span>
                </Link>
             </div>
             {/* FSSC 22000 Card */}
             <div className="bg-gray-50 rounded-xl p-8 border border-gray-200 hover:shadow-lg transition-all">
                <h3 className="text-2xl font-bold text-[#0F1A3E] mb-3">FSSC 22000 Certification</h3>
                <p className="text-gray-600 mb-6">GFSI-recognized food safety certification. A must for food manufacturers supplying major retailers.</p>
                <Link to="/fssc-22000" className="text-orange-600 font-semibold hover:text-orange-700 flex items-center group">
                   Learn more <span className="ml-2 transform group-hover:translate-x-1 transition-transform">→</span>
                </Link>
             </div>
          </div>
